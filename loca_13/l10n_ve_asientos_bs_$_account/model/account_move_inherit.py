        ...
        for selff in self:
            ...
            if self.env.company.currency_id.id==selff.currency_id.id:
                if selff.custom_rate!=True:
                    ...
                    valor=abs(selff.amount_total_signed/selff.os_currency_rate)
        ...
        for selff in self:
            ...
            if self.env.company.currency_id.id==selff.currency_id.id:
                if selff.custom_rate!=True:
                    ...
                    valor=abs(selff.amount_untaxed_signed/selff.os_currency_rate)
        ...
        for selff in self:
            ...
            if self.env.company.currency_id.id==selff.currency_id.id:
                if selff.custom_rate!=True:
                    ...
                    valor=abs(selff.amount_residual_signed/selff.os_currency_rate)
        ...
        for selff in self:
            ...
            if self.env.company.currency_id.id==selff.currency_id.id:
                if selff.custom_rate!=True:
                    ...
                    valor=abs(selff.amount_tax_signed/selff.os_currency_rate)
