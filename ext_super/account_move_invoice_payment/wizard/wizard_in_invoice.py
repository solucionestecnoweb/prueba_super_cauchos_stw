...
class WizardInInvoice(models.TransientModel):
    ...
    def generate_xls_report(self):
        ...
        ws1 = wb1.add_sheet(_('Payable Invoices Report'))
        fp = BytesIO()
        ...
        ws1.write_merge(row,row, 3, 7, _("Payable Invoices Report"), header_content_style)
        ...
        self.write({'state': 'get', 'report': out, 'name': _('Payable Invoices Report ')+ fecha +'.xls'})
        return {
